          ...
          <MusicProvider>
            <div id="app-mount-root" className="flex-1 flex flex-col min-h-screen">
              <div className="fixed inset-0 z-[-1] pointer-events-none overflow-hidden">
                ...
                <div className="absolute inset-0 z-[-8] opacity-55 dark:opacity-10 transition-opacity duration-300 transform-gpu" style={{ background: `linear-gradient(-45deg, ${siteConfig.themeColors.join(', ')})`, backgroundSize: '400% 400%', animation: 'gradientMove 30s ease infinite' }}></div>
