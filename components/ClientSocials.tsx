  ...
  return (
    <div className="flex gap-2 justify-center flex-wrap">
      ...
      {siteConfig.social?.email && (
        <button onClick={() => copy(siteConfig.social!.email!, '邮箱')} className={btnClass}>
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
        </button>
      )}
      {siteConfig.social?.qq && (
        <button onClick={() => copy(siteConfig.social!.qq!, 'QQ号')} className={btnClass}>
      ...
      {siteConfig.social?.wechat && (
        <button onClick={() => copy(siteConfig.social!.wechat!, '微信')} className={btnClass}>
