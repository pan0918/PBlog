...
export default function ProfileCard({ postCount, momentCount, photoCount, showStats = true, surfaceTone = 'warm' }: ProfileCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Social Icons */}
      <div className="flex gap-2 justify-center mb-4" onClick={(e) => e.stopPropagation()}>
