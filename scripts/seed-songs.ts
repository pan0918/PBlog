...
const SONGS: SeedSong[] = [
  {
    title: "乌鸦", artist: "许嵩", album: "呼吸之野", sort_order: 1,
  ...
  {
    title: "内线", artist: "许嵩", album: "自定义", sort_order: 2,
  ...
  {
    title: "千古", artist: "许嵩", album: "千古", sort_order: 3,
  ...
  {
    title: "单人旅途", artist: "许嵩", album: "寻雾启示", sort_order: 4,
  ...
  {
    title: "南山忆", artist: "许嵩", album: "半城烟沙", sort_order: 5,
  ...
  {
    title: "叹服", artist: "许嵩", album: "寻雾启示", sort_order: 6,
  ...
  {
    title: "如果当时", artist: "许嵩", album: "自定义", sort_order: 7,
    pic: "https://p3.music.126.net/Zg4XDfsiRi5vawjSWPP8Ng==/109951172899966259.jpg",
  ...
  {
    title: "如约而至", artist: "许嵩", album: "寻宝游戏", sort_order: 8,
  ...
  {
    title: "山水之间", artist: "许嵩", album: "不如吃茶去", sort_order: 9,
  ...
  {
    title: "弹指一挥间", artist: "许嵩", album: "不如吃茶去", sort_order: 10,
    pic: "https://p3.music.126.net/NBjIuSJ7LRugXdATt3j8AA==/109951172321467418.jpg",
  ...
  {
    title: "我想牵着你的手", artist: "许嵩", album: "许嵩单曲集", sort_order: 11,
  ...
  {
    title: "梧桐灯", artist: "许嵩", album: "不如吃茶去", sort_order: 12,
    pic: "https://p3.music.126.net/NBjIuSJ7LRugXdATt3j8AA==/109951172321467418.jpg",
  ...
  {
    title: "温泉", artist: "许嵩/刘美麟", album: "温泉", sort_order: 13,
  ...
  {
    title: "粉色信笺", artist: "许嵩", album: "许嵩单曲集", sort_order: 14,
    pic: "https://p4.music.126.net/q6LhHJxJw21aGDN13HcyKg==/109951172188951978.jpg",
  ...
  for (let i = 0; i < SONGS.length; i++) {
    ...
    try {
      await db.execute({
        ...
        args: [id, song.title, song.artist, song.album, song.pic, song.url, song.lrc, song.sort_order, now, now],
      });
      console.log(`  ✅ [${i + 1}/${SONGS.length}] ${song.title}`);
    } catch (err: unknown) {
      const msg = err instanceof Error ? err.message : String(err);
      if (msg.includes('UNIQUE')) {
        console.log(`  ⏭️  [${i + 1}/${SONGS.length}] ${song.title} - already exists`);
      } else {
        console.error(`  ❌ [${i + 1}/${SONGS.length}] ${song.title} - ${msg}`);
      }
    }
  }
